...
public class PlayGameState extends GameStateImpl {
	...
	class ChallengeMode {
		...
		void loadLevel(EntityTemplates templates, Level level) {
			...
			final Camera camera = new CameraRestrictedImpl(0f, 0f, 40f, 0f, Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), new Rectangle(0f, 0f, worldWidth, worldHeight));
	...
	class RandomMode {
		...
		void create(PlayGameState p) {
			...
			final Camera camera = new CameraRestrictedImpl(0f, 0f, 32f, 0f, Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), new Rectangle(0f, 0f, worldWidth, worldHeight));
