...
public class FadeInTransition extends GameTransitions.EnterTransition {
	...
	public FadeInTransition(Screen screen, ResourceManager<String> resourceManager, float time) {
		super(screen, time);
		this.time = time;
		this.resourceManager = resourceManager;
	}

	public FadeInTransition(Screen screen, ResourceManager<String> resourceManager, float time, TransitionHandler transitionHandler) {
