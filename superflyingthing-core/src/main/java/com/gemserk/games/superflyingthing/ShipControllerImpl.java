...
public class ShipControllerImpl implements ShipController {
	...
	public void update(int delta) {
		...
		if (Gdx.app.getType() != ApplicationType.Android) {
			...
			movementDirection = calculateDirectionWithVariableSensibility(movementDirection, direction, 0.5f, 0.001f * delta, 1.5f);
		} else {
			...
			for (int i = 0; i < 5; i++) {
				...
				movementDirection = calculateDirectionWithVariableSensibility(movementDirection, direction, 0.2f, 0.001f * delta, 1.5f);
