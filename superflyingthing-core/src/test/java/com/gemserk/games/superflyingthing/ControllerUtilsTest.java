...
public class ControllerUtilsTest {
	...
	public void testSensibilityCalculationForAndroid() {
		assertThat(ControllerUtils.value(400f, 0, 0f, 400f), IsEqual.equalTo(-1f));
		assertThat(ControllerUtils.value(400f, 800, 0f, 400f), IsEqual.equalTo(1f));
		assertThat(ControllerUtils.value(400f, 400, 0f, 400f), IsEqual.equalTo(0f));

		assertThat(ControllerUtils.value(400f, 600, 0f, 400f), IsEqual.equalTo(0.5f));
		assertThat(ControllerUtils.value(400f, 200, 0f, 400f), IsEqual.equalTo(-0.5f));
		
		assertThat(ControllerUtils.value(400f, 600, 0.5f, 400f), IsEqual.equalTo(0.75f));
		assertThat(ControllerUtils.value(400f, 200, 0.5f, 400f), IsEqual.equalTo(-0.75f));
		
		assertThat(ControllerUtils.value(400f, 500, 0.5f, 50f), IsEqual.equalTo(1f));
		assertThat(ControllerUtils.value(400f, 425, 0.5f, 50f), IsEqual.equalTo(0.75f));
	}
